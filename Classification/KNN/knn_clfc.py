...
classifier = KNeighborsClassifier(n_neighbors=1, metric='minkowski') # by decreasing neighbors number, model will be avoid outliner data(the dataset has outliner data). So, it will be predict better
